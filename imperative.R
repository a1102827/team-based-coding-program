...
#load (paste(base_path, "/results/tem_results.Rdata", sep=""))

load(createPath("/results/tem_results.Rdata"))
...
#base_path = getwd()
#results_folder_path = paste(base_path, "/results/tem_results.Rdata", sep="")
